...
export default function Home_dark() {
    return (
      ...
      <div id="1" className="snap-start relative flex items-center justify-center h-screen w-screen">
        <div className="grid grid-cols-2 gap-2 w-screen lg:max-w-5xl bg-slate-600 p-10 rounded-3xl bg-opacity-20 z-20">
       <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b1/Ishihara_9.svg/360px-Ishihara_9.svg.png" alt="" className="bg-white rounded-3xl p-5" />
       <div className="grid-cols-3 grid grid-rows-3 gap-4 text-2xl">
      ...
      <div id="2" className="snap-start relative flex items-center justify-center h-screen w-screen">
        <div className="grid grid-cols-2 gap-8 w-screen lg:max-w-5xl bg-slate-600 p-10 rounded-3xl bg-opacity-20 z-20">
       <img src="https://www.colorlitelens.com/images/Ishihara/Ishihara_00.jpg" alt="" className="bg-white rounded-3xl p-5" />
       <div className="grid-cols-3 grid grid-rows-3 gap-4 text-2xl">
        <a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">71</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">73</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">74</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">76</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">78</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">79</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">81</a><a href="#3" className="p-5 bg-slate-500 rounded-3xl flex items-center justify-center">84</a><a href="#3" className="p-5 bg-slate-400 rounded-3xl flex items-center justify-center">Skip</a>
       </div>
       </div>
      ...
      <div id="3" className="snap-start relative flex items-center justify-center h-screen w-screen">
        <div className="grid grid-cols-2 gap-2 w-screen lg:max-w-5xl bg-slate-600 p-10 rounded-3xl bg-opacity-20 z-20">
       <img src="https://www.colour-blindness.com/CBTests/ishihara/Plate10.gif" alt="" className="bg-white rounded-3xl p-5 lg:w-96" />
       <div className="grid-cols-3 grid grid-rows-3 gap-4 text-2xl">
